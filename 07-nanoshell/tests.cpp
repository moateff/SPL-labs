...
extern "C" int nanoshell_main(int argc, char *argv[]);

class NanoShellTest : public ::testing::Test {
protected:
    std::string prompt;
    ...
    std::pair<std::string, int> run_shell_command(const std::string &input) {
        ...
        if (pid == 0) { // Child process
            ...
            char *argv[] = {(char*)"./nano_shell", NULL};
            int status = nanoshell_main(1, argv);
...
class NanoShellEchoTest : public NanoShellTest {
};

class NanoShellPwdTest : public NanoShellTest {
};

class NanoShellCdTest : public NanoShellTest {
};

class NanoShellExtCmdTest : public NanoShellTest {
};

class NanoShellMixTest : public NanoShellTest {
};

class NanoShellVariables : public NanoShellTest {
};

TEST_F(NanoShellTest, PressEnterWithoutCommand) {
    std::string input = "\n\n";
...
TEST_F(NanoShellTest, HandleMultipleSpaces) {
...
TEST_F(NanoShellTest, ExitCommand) {
...
TEST_F(NanoShellTest, InvalidCommand) {
...
TEST_F(NanoShellEchoTest, EchoCommand) {
    std::string input = "echo Hello, World!";
    std::cout << "Test input: \"" << input << "\"" << std::endl;
    std::cout << "Your shell output:" << std::endl;
    std::string expected_output = prompt + "Hello, World!\n" + prompt;
...
TEST_F(NanoShellEchoTest, LargeNumberOfConsecutiveCommands) {
    std::string input;
...
TEST_F(NanoShellEchoTest, EchoWithLargeTextWithoutSpaces) {
...
TEST_F(NanoShellEchoTest, EchoWithLargeNumberOfArguments) {
...
TEST_F(NanoShellPwdTest, PwdCurrentDirectory) {
...
TEST_F(NanoShellPwdTest, PwdChangeToParentDirectory) {
    ASSERT_EQ(chdir(".."), 0);
...
TEST_F(NanoShellPwdTest, PwdChangeDirectory) {
...
TEST_F(NanoShellPwdTest, PwdChangeToNewDirectory) {
...
TEST_F(NanoShellPwdTest, PwdLongPath) {
...
TEST_F(NanoShellCdTest, CdCommand) {
...
TEST_F(NanoShellCdTest, InvalidCdCommand) {
...
TEST_F(NanoShellExtCmdTest, ExternalCommand) {
...
TEST_F(NanoShellExtCmdTest, ExternalCommandWithLargeNumberOfArguments) {
    std::string input = "cat /tmp/input.txt";
    for (int i = 0; i < 50; ++i) {
        input += "  /tmp/input.txt";
    }
...
TEST_F(NanoShellMixTest, CreateRemoveDir) {
    const char *new_dir = "test_dir";
    std::string input;
    std::string expected_output;
...
TEST_F(NanoShellVariables, VariableAssignment) {
...
TEST_F(NanoShellVariables, VariableSubstitution) {
...
TEST_F(NanoShellVariables, VariableSubstitutionInPath) {
...
TEST_F(NanoShellVariables, NonExistingVariableSubstitution) {
...
TEST_F(NanoShellVariables, NonExistingVariableSubstitutionInString) {
...
TEST_F(NanoShellVariables, ExportVariable) {
...
TEST_F(NanoShellVariables, CreateRemoveDirWithVars) {
...
TEST_F(NanoShellVariables, EchoWithLargeNumberOfArgumentsWithVars) {
